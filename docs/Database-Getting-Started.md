...
## Basic Example
The Coast [query builder](Query-Builder.md) has a data-driven API, meaning all queries are clojure vectors, similar to [views](Views.md) and the [routes](Routes.md).
...
See the [query builder](Query-Builder.md) documentation for the complete API reference.
